...
s1 = makeSample("house/004_OH.wav")
-- s2 = makeSample("drum/004_drum5.wav")
proAudio.soundUpdate( s1[1], 1, 0, 1, 1.5 )
s1:bind("c")
-- s2:bind("b")
g = makeGroup("group")
-- g2 = makeGroup("group2")
-- g:add("drum/000_drum1.wav")
g:add("drum/001_drum2.wav")
...
-- p : add('A', "hand/hand17.wav")
-- p : add('X', "drumtraks/009_DT Snare.wav")
-- p : set('.X...A...X...A..')
...
gen:setFunction(
	function ()
		...
		for i=1, math.floor(4.25*BEATTIME*gen.sr) do
...
gen2:setFunction(
	function ()
		...
		for i=1, math.floor(4.25*BEATTIME*gen2.sr) do
...
gen3:setFunction(
	function ()
		...
		for i=1, math.floor(4.25*BEATTIME*gen3.sr) do
...
gen4:setFunction(
	function ()
		...
		for i=1, math.floor(4.25*BEATTIME*gen4.sr) do
